...
function Library:Window(title)
            ...
            function()
                if script.Parent.Parent.Container.Size == UDim2.new(0, 204, 0, 762) then
                    ...
                    game:GetService("TweenService"):Create(
                        script.Parent,
                        TweenInfo.new(0.25),
                        {ImageColor3 = Color3.fromRGB(0, 255, 102)}
                    ):Play()
    ...
    function Lib:TextLabel(name)
        local TextLabelContainer = Instance.new("Frame")
        local TextLabel = Instance.new("TextLabel")

        TextLabelContainer.Name = "TextLabelContainer"
        TextLabelContainer.Parent = Container
        TextLabelContainer.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
        TextLabelContainer.BorderSizePixel = 0
        TextLabelContainer.Size = UDim2.new(0, 204, 0, 30)

        TextLabel.Name = "TextLabel"
        TextLabel.Parent = TextLabelContainer
        TextLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        TextLabel.BackgroundTransparency = 1.000
        TextLabel.Position = UDim2.new(0.0245098043, 0, 0.142857104, 0)
        TextLabel.Size = UDim2.new(0, 169, 0, 20)
    ...
    function Lib:TextField(name, placeholder, callback)
        local TextFieldContainer = Instance.new("Frame")
        local TextFieldName = Instance.new("TextLabel")
        local TextField = Instance.new("TextBox")
        local UICorner_5 = Instance.new("UICorner")

        TextFieldContainer.Name = "TextFieldContainer"
        TextFieldContainer.Parent = Container
        TextFieldContainer.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
        TextFieldContainer.BorderSizePixel = 0
        TextFieldContainer.Size = UDim2.new(0, 204, 0, 30)

        TextFieldName.Name = "TextFieldName"
        TextFieldName.Parent = TextFieldContainer
        TextFieldName.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        TextFieldName.BackgroundTransparency = 1.000
        TextFieldName.Position = UDim2.new(0.0245098043, 0, 0.142857104, 0)
        TextFieldName.Size = UDim2.new(0, 169, 0, 20)
        TextFieldName.Font = Enum.Font.GothamSemibold
        TextFieldName.Text = name
        TextFieldName.TextColor3 = Color3.fromRGB(255, 255, 255)
        TextFieldName.TextScaled = true
        TextFieldName.TextSize = 14.000
        TextFieldName.TextWrapped = true
        TextFieldName.TextXAlignment = Enum.TextXAlignment.Left

        TextField.Name = "TextField"
        TextField.Parent = TextFieldContainer
        TextField.BackgroundColor3 = Color3.fromRGB(39, 39, 39)
        TextField.BorderColor3 = Color3.fromRGB(27, 42, 53)
        TextField.BorderSizePixel = 0
        TextField.Position = UDim2.new(0.524509785, 0, 0.13333334, 0)
        TextField.Size = UDim2.new(0, 130, 0, 20)
        TextField.Font = Enum.Font.Gotham
        TextField.PlaceholderColor3 = Color3.fromRGB(113, 113, 113)
        TextField.PlaceholderText = placeholder or "Type..."
        TextField.Text = ""
        TextField.TextColor3 = Color3.fromRGB(255, 255, 255)
        TextField.TextSize = 14.000
        TextField.TextWrapped = true

        UICorner_5.CornerRadius = UDim.new(0, 3)
        UICorner_5.Parent = TextField

        if callback then
            TextField.FocusLost:Connect(
                function()
...
local window = Library:Window("Bebos Stuff")
